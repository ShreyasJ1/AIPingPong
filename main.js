...
function gotPoses(results) {
  if (results.length > 0) {
    ...
    console.log("right Wrist X = " + rightWristX + "right Wrist Y = " + rightWristY + " Score = " + scoreRightWrist);
...
//function reset when ball does not come in the contact with the paddle
function reset() {
  ball.x = width / 2 + 100,
    ball.y = height / 2 + 100;
  ball.dx = 3;
